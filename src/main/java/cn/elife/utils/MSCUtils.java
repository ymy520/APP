...
import cn.elife.elife.SearchActivity;
 ...
 * 使用方式：1.在你的类中调用该工具类的getVoiceReslut方法，参数:"你的类.this"(说法不规范，好理解=_+)。
...
public class MSCUtils {
    public static void getVoiceReslut(final SearchActivity searchActivity) {
        final List<String> chineseWordList = new ArrayList<String>();//分词结果集
        //1.创建RecognizerDialog对象
        RecognizerDialog mDialog = new RecognizerDialog(searchActivity, new InitListener() {
            @Override
        ...
        mDialog.setListener(new RecognizerDialogListener() {
            ...
            public void onResult(RecognizerResult recognizerResult, boolean b) {
                ...
                searchActivity.voice2List(chineseWordList);//开始回调
            }
